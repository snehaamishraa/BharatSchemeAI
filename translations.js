...
const translations = {
  ...
  'hi': {
    ...
    'male': 'पुरुष',
    'female': 'महिला',
    'non_binary': 'गैर-द्विआधारी',
    'prefer_not_to_say': 'नहीं बताना पसंद करते',
    'other': 'अन्य',
    'occupation': 'व्यवसाय',
  ...
  'te': {
    ...
    'male': 'మగ',
    'female': 'ఆడ',
    'non_binary': 'నాన్‌-బైనరీ',
    'prefer_not_to_say': 'చెప్పుకోకూడదు',
    'other': 'ఇతర',
    'occupation': 'వృత్తి',
  ...
  'kn': {
    ...
    'prefer_not_to_say': 'ಹೇಳಬಯಸುವುದಿಲ್ಲ',
    'other': 'ಇತರ',
    'occupation': 'ವೃತ್ತಿ',
  ...
  'ml': {
    ...
    'male': 'പുരുഷൻ',
    'female': 'സ്ത്രീ',
    'non_binary': 'നോൺ-ബൈനറി',
    'prefer_not_to_say': 'പറയാൻ ഇഷ്ടപ്പെടുന്നില്ല',
    'other': 'മറ്റ്',
    'occupation': 'തൊഴിൽ',
  ...
  'mr': {
    ...
    'female': 'महिला',
    'non_binary': 'गैर-द्विआधारी',
    'prefer_not_to_say': 'कळं सुद्ध करत',
    'other': 'इतर',
    'occupation': 'व्यवसाय',
  ...
  'gu': {
    ...
    'male': 'પુરુષ',
    'female': 'સ્ત્રી',
    'non_binary': 'ગૈર-બોઇમાાની',
    'prefer_not_to_say': 'કહીં પછંદ કરેં આસ૆',
    'other': 'અન્ય',
    'occupation': 'વ્યવસાય',
  ...
  'bn': {
    ...
    'male': 'পুরুষ',
    'female': 'মহিলা',
    'non_binary': 'জড়-অঅধীডি',
    'prefer_not_to_say': 'বলতে পছন্দ করাই',
    'other': 'অন্যান্য',
    'occupation': 'পেশা',
